...
import { ChartBarIcon, CalendarDaysIcon, BanknotesIcon } from '@heroicons/react/24/outline';
      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-slate-500">
            View booking trends and revenue insights
          </p>
        </div>
        ...
        <div className="rounded-xl bg-white p-8 text-center shadow-md ring-1 ring-slate-200">
          ...
          <p className="mt-1 text-sm text-slate-500">
            Reports will appear here once you have bookings
          </p>
        </div>
      </div>
    </div>
